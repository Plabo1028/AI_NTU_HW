...
def expectiminimax(grid, player, depth , demo ):
	...
	if depth == 0:
		...
		# demo 1: emptyTiles() + smooth()
			#print ("empty",score_evaluation_emptyTiles(grid))
			#print ("smooth",(30 * score_evaluation_smooth(grid)))
			return score_evaluation_emptyTiles(grid) + 100 * score_evaluation_smooth(grid)
		else:
		# demo 2: snake()
